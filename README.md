...
- `scripts/sync_daily_price_release.py`
  - GitHub Release 자산 기반 `DAILY_PRICE` 일괄 갱신
...
- `DAILY_PRICE`(최근 N일/provider): 매일 1회, 현재는 `.github/workflows/sync_daily_price_release.yml`에서 21:00 KST daily sync로 수행
- `DAILY_PRICE`(release 일괄): 수동 실행
- `STOCK_MASTER`: 주 1회
- `STOCK_INDUSTRY`: 월 1회
- `STOCK_DIVIDEND`: 주 1회
